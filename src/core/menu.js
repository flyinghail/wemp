...
import mysqlIcon from '../assets/mysql.png?asset';
import phpIcon from '../assets/php.png?asset';
import phpmyadminIcon from '../assets/phpmyadmin.png?asset';
import passwordIcon from '../assets/password.png?asset';
...
const icons = {
  ...
  mysql: nativeImage.createFromDataURL(mysqlIcon),
  php: nativeImage.createFromDataURL(phpIcon),
  phpmyadmin: nativeImage.createFromDataURL(phpmyadminIcon),
  password: nativeImage.createFromDataURL(passwordIcon)
};
